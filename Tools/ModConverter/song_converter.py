# Renoise -> tracker-tone song converter GUI.
#
# Based on DuinoTune by Blake Livingston:
#   https://github.com/blakelivingston/DuinoTune
#
# Modified by Miguel Angel Exposito (2017-2020) for use with the Melbits Pod
# audio asset pipeline. Upstream DuinoTune license terms apply; Melbot-
# specific modifications are released under the same.
                ...
                if in_dir.get() and out_dir.get():
                    ...
                    for songfile, modtime in song_stats:
                        ...
                        if modtime > out_song_mtime:
                            ...
                            out = xrns2tt.xrns_to_tt(songfile, out_path_songname, {})
