...
#define SC7A20_CACHED_REGS_SIZE         (19)
...
static const uint8_t kReadRegs[] = {WHO_AM_I, STATUS_REG, AOI1_SRC, AOI2_SRC, CLICK_SRC, FIFO_SRC_REG, OUT_X_L, OUT_X_H, OUT_Y_L, OUT_Y_H, OUT_Z_L, OUT_Z_H};
...
#define SC7A20_X_ENABLE   CTRL_REG1_XEN
#define SC7A20_Y_ENABLE   CTRL_REG1_YEN
#define SC7A20_Z_ENABLE   CTRL_REG1_ZEN
#define SC7A20_LOWPOWER   CTRL_REG1_LPEN

#define SC7A20_RATE_POWEROFF            CTRL_REG1_ODR_POWEROFF
#define SC7A20_RATE_1HZ                 CTRL_REG1_ODR_NORMAL_LP_1HZ
#define SC7A20_RATE_10HZ                CTRL_REG1_ODR_NORMAL_LP_10HZ
#define SC7A20_RATE_25HZ                CTRL_REG1_ODR_NORMAL_LP_25HZ
#define SC7A20_RATE_50HZ                CTRL_REG1_ODR_NORMAL_LP_50HZ
#define SC7A20_RATE_100HZ               CTRL_REG1_ODR_NORMAL_LP_100HZ
#define SC7A20_RATE_200HZ               CTRL_REG1_ODR_NORMAL_LP_200HZ
#define SC7A20_RATE_400HZ               CTRL_REG1_ODR_NORMAL_LP_400HZ
#define SC7A20_RATE_1600HZ              CTRL_REG1_ODR_NORMAL_LP_1600HZ
#define SC7A20_RATE_1250HZ_LP_5000HZ    CTRL_REG1_ODR_NORMAL_1250HZ_LP_5000HZ

#define SC7A20_RANGE_2G  CTRL_REG4_FS_2G
#define SC7A20_RANGE_4G  CTRL_REG4_FS_4G
#define SC7A20_RANGE_8G  CTRL_REG4_FS_8G
#define SC7A20_RANGE_16G CTRL_REG4_FS_16G

#define SC7A20_EVENT_ERROR      (0)
#define SC7A20_EVENT_DRDY       (1)
#define SC7A20_EVENT_MOTION     (2)
#define SC7A20_EVENT_CLICK      (3)

#define SC7A20_HPF_MODE_RESET_ON_REF_READ  (0)
#define SC7A20_HPF_MODE_DIFF_WITH_REF      (1)
#define SC7A20_HPF_MODE_NORMAL             (2)
#define SC7A20_HPF_MODE_RESET_ON_INTERRUPT (3)

#define SC7A20_HPF_CUTOFF_0 (0)
#define SC7A20_HPF_CUTOFF_1 (1)
#define SC7A20_HPF_CUTOFF_2 (2)
#define SC7A20_HPF_CUTOFF_3 (3)

#define SC7A20_MAX_BUS_TRANSFERS (19)

#define SC7A20_ACTIVITY_X_LOW      AOI1_CTRL_REG_XLIE
#define SC7A20_ACTIVITY_X_HIGH     AOI1_CTRL_REG_XHIE
#define SC7A20_ACTIVITY_Y_LOW      AOI1_CTRL_REG_YLIE
#define SC7A20_ACTIVITY_Y_HIGH     AOI1_CTRL_REG_YHIE
#define SC7A20_ACTIVITY_Z_LOW      AOI1_CTRL_REG_ZLIE
#define SC7A20_ACTIVITY_Z_HIGH     AOI1_CTRL_REG_ZHIE
#define SC7A20_ACTIVITY_BOOL_AND   AOI1_CTRL_REG_AOI

#define SC7A20_HPF_TARGET_AOI1 CTRL_REG2_HPIS1_EN
#define SC7A20_HPF_TARGET_AOI2 CTRL_REG2_HPIS2_EN

#define SC7A20_HPF_TARGET_CLICK CTRL_REG2_HPCLICK
#define SC7A20_HPF_TARGET_OUTPUT CTRL_REG2_FDS

#define SC7A20_CLICK_AXIS_X_SINGLE CLICK_CTRL_REG_XS
#define SC7A20_CLICK_AXIS_X_DOUBLE CLICK_CTRL_REG_XD
#define SC7A20_CLICK_AXIS_Y_SINGLE CLICK_CTRL_REG_YS
#define SC7A20_CLICK_AXIS_Y_DOUBLE CLICK_CTRL_REG_YD
#define SC7A20_CLICK_AXIS_Z_SINGLE CLICK_CTRL_REG_ZS
#define SC7A20_CLICK_AXIS_Z_DOUBLE CLICK_CTRL_REG_ZD
...
typedef struct
{
    ...
    nrfx_atomic_flag_t          isBufferLocked;
    nrfx_atomic_u32_t           readOps;

    SC7A20_sample_t             sampleBuffer;
...
//#define SC7A20_USE_INT1_FOR_MOTION
